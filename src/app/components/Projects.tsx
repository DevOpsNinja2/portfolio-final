...
const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    description:
      "A web application that predicts health issues using ML and LLMs.",
    image: "/proj/health.png",
    link: "https://github.com/DevOpsNinja2/smart-health-prediction",
    tag: ["All", "Software"],
  },
  {
    id: 3,
    ...
    description:
      "A web application for managing auctions using Django and SQL.",
    image: "/proj/auction.png",
    link: "https://github.com/DevOpsNinja2/Auction-System",
    tag: ["All", "Software"],
  },
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3 py-6 sm:py-8">
          {["All", "Software",  "Publication"].map((category) => (
            <button
              key={category}
