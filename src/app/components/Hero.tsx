      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-12 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          <p className="text-gray-300 text-sm sm:text-base md:text-lg mb-4 sm:mb-6 lg:text-xl max-w-2xl">
            ...
            Proficient in Python for backend development, scripting, and automation, with hands-on experience in JavaScript for interactive front-end interfaces.
          </p>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg mb-6 sm:mb-8 lg:text-xl max-w-3xl">
            As an MCA student from Bangalore, India, I&apos;m passionate about{" "}
            <span className="text-yellow-500 font-medium">full-stack development, DevOps</span>. My expertise in{" "}
            <span className="text-yellow-500 font-medium">Python, React, Cloud technologies, and Machine Learning
            </span> 
            allows me to build scalable applications and innovative solutions across various domains.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center sm:justify-start relative z-0">
            ...
            <Link
              href="https://drive.google.com/file/d/1IWX-pj0qX-2GiQQViU1-0p4CDcdCySFh/view?usp=drive_link"
